...
<head>
    ...
    <title>Dashboard - ES Gaya Belajar</title>
    <!-- CSS files -->
                                ...
                                <a class="nav-link" href="<?= base_url('/') ?>">
                                    <span
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                            ...
                                            <path d="M5 12v7a2 2 0 0 0 2 2h10a2 0 0 0 2 -2v-7" />
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-menu-columns">
                                        <div class="dropdown-menu-column">
                                            <a class="dropdown-item" href="<?= site_url('gaya-belajar') ?>">
                                                Gaya Belajar
                                            </a>
                                            <a class="dropdown-item" href="<?= site_url('pertanyaan') ?>">
                                                Pertanyaan
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="." class="link-secondary">ES Gaya Belajar</a></li>
                            </ul>
                        </div>
